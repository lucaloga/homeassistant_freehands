...
class FreehandsFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    def async_get_options_flow(config_entry):
        return FreehandsOptionsFlowHandler(config_entry)
...
class FreehandsOptionsFlowHandler(config_entries.OptionsFlow):
    """Config flow options handler for freehands."""
